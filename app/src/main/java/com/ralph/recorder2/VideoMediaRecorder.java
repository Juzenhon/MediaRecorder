...
//        mRecorder.setMaxDuration(10000);
        ...
        mRecorder.setVideoEncodingBitRate(2 * previewWidth * previewHeight);
...
//        });
    ...
    public boolean startRecord(CameraWrapper wrapper, int width, int height, int orient) {
        ...
        if (mOutputPath == null) {
            mOutputPath = Environment.getExternalStorageDirectory().getPath() + "/"
        ...
        try {
            ...
            Camera.Size size = CameraUtils.getOptimalVideoSize(parameters.getSupportedVideoSizes(), width, height);
    ...
    @Override
    public void takePicture(final CameraWrapper wrapper, final ITakePictureCallback callback, final int orient) {
