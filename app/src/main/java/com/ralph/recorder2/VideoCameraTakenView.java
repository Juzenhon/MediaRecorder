...
//                            post(recordEndRunnable);
    ...
    public VideoCameraTakenView(Context context, AttributeSet attrs) {
        ...
        progressPaint.setStrokeWidth(dp2px(5f));
        progressPaint.setColor(0xff3395FF);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        innerRadiusMax = dp2px(27);
        innerRadiusMin = dp2px(18.5f);
        outerRadiusMax = dp2px(54.5f);
        outerRadiusMin = dp2px(35f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isShrink && isRecording && actionListener != null && actionListener.getRecordDuration() != 0) {
